...
//	if(!successFunc) {
		successFunc = function() {
			if(parent.document.location.href == 'http://www.kurt-climbing.com/Joomla/index.php/cllib-users-cllogin') {
				console.log("changing to front page...");
				parent.document.location.href = 'http://www.kurt-climbing.com/Joomla';
			}
		}
//	}
