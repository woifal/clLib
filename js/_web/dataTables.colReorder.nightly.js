...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo )
{
	...
	if ( oSettings.aoColumns[iFrom].bVisible )
	{
		...
		console.log("iterating theads >" + iLen + "<");
...
/*
* 2014-11-13 WD: Don't process footer if there is none!
*/
		/* Footer */
		if ( oSettings.nTFoot !== null && JSON.stringify(oSettings.nTFoot) != "{}")
		{
			console.log("processing tfoot >" + JSON.stringify(oSettings.nTFoot) + "<");
		
			nTrs = oSettings.nTFoot.getElementsByTagName('tr');
			console.log("iterating tfoot >" + iLen + "<");
			for ( i=0, iLen=nTrs.length ; i<iLen ; i++ )
			{
				fnDomSwitch( nTrs[i], iVisibleIndex, iInsertBeforeIndex );
			}
		...
		{
			//console.log("1iterating tbody >" + iLen + "<");
