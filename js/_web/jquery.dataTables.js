...
//				 if ( aApplied[i][j] === undefined )
				if ( aApplied[i][j] === undefined && aoLocal[i][j] !== undefined )
				{
	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
		...
		//console.log("1Filter" + JSON.stringify(oSettings.oPreviousSearch));
		console.log("2Filter" + JSON.stringify(oSettings.aoPreSearchCols));
	...
	function _fnFilterColumn ( settings, searchStr, colIdx, regex, smart, caseInsensitive )
	{
		...
		for ( var i=display.length-1 ; i>=0 ; i-- ) {
			/*
			* [2014-11-28 WD]
			* Changed to use _aData instead of _aFilterData.
			...
			*/
			...
			if(data != "" && data != "?") {
				...
				//console.log("complete row data" + JSON.stringify(settings.aoData[ display[i] ]));
			}
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		if ( input.length <= 0 ) {
			...
			for ( i=display.length-1 ; i>=0 ; i-- ) {
				//alert("xxxx" + settings.aoData[ display[i] ]);
	...
	{
		console.log("sortattachlistener " + attachTo);
		var col = settings.aoColumns[ colIdx ];
