...
//			xhr.setRequestHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0");
            ...
            var userInfo = clLib.getUserInfo();
            var clUserId =  userInfo["_id"] || "";
            var clSessionToken = userInfo["sessionToken"] || ""; 
            console.log("clUserId Is >" + clUserId + "<");
            xhr.setRequestHeader("clUserId", clUserId + "y");
//            xhr.setRequestHeader("clSessionToken", clLib.getUserInfo()["sessionToken"]);
