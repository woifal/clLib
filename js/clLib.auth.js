    ...
    ,processAuthObj: function(urlAuthObj, successFunc, noLogin) {
		...
		try {
	        ...
	        if(urlAuthObj.indexOf("#_=_") > -1) {
				...
				// 2016-04-10: New google oauth url format( "#" at the end without any underscores..)
				if(urlAuthObj.indexOf("#") == (urlAuthObj.length -1) ) {
					urlAuthObj = urlAuthObj.substring(0, urlAuthObj.lastIndexOf("#"));
				}
				
				console.log("final authobj >" + urlAuthObj + "<");
